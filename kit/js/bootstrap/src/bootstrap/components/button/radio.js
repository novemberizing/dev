...
export default class RadioBtn extends Context {
    constructor(props) {
        super(props);
    }
    ...
    render() {
        ...
        return ([
            <input key={0} type="radio" id={id} name={name} className="btn-check" autoComplete="off" value={value} defaultChecked={defaultChecked}/>,
