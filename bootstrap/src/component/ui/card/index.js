    ...
    render() {
        return (
            <div className={Strings.join(["mb-4", Bootstraps.xl("col", this.props.xl), Bootstraps.md("col", this.props.md)])} >
                <div className={Strings.join(["card", this.props.shadow && "shadow", Bootstraps.height(this.props.height), Bootstraps.py(this.props.py), this._border(this.props.border, this.props.type)])}>
