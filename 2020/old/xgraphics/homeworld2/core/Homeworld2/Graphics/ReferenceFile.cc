...
namespace Homeworld2
{
    namespace Graphics
    {
        ...
        Homeworld2::Graphics::Reference * ReferenceFile::load(const x::string & path, const x::string & name)
        {
            x::file::input::stream in = x::file::input::stream::open(path);
            Homeworld2::Graphics::Reference * object = new Homeworld2::Graphics::Reference(name);
            while(!in.finish())
            {
        ...
        Homeworld2::Graphics::Reference * ReferenceFile::load(const x::file & file, const x::string & name)
        {
            return ReferenceFile::load(file.path(), name);
        }

        void ReferenceFile::version(ReferenceFile::Context & root, Homeworld2::Graphics::Reference & object, x::file::input::stream & in)
        {
        ...
        void ReferenceFile::category(ReferenceFile::Context & root, Homeworld2::Graphics::Reference & object, x::file::input::stream & in)
        {
            ReferenceFile::debug(root);
        ...
        void ReferenceFile::data(ReferenceFile::Context & root, Homeworld2::Graphics::Reference & object, x::file::input::stream & in)
        {
        ...
        Homeworld2::Graphics::Material ReferenceFile::material(ReferenceFile::Context & root, x::file::input::stream & in)
        {
            ReferenceFile::debug(root);
            Homeworld2::Graphics::Material material;
            material.name(root.str(in));
            material.shader("homeworld2 " + root.str(in));
        ...
        x::graphics::texture ReferenceFile::texture(ReferenceFile::Context & root, x::file::input::stream & in)
        {
            ReferenceFile::debug(root);
        ...
        Homeworld2::Graphics::Multimesh ReferenceFile::multimesh(ReferenceFile::Context & root, x::file::input::stream & in)
        {
            ReferenceFile::debug(root);
            Homeworld2::Graphics::Multimesh multimesh;
        ...
        Homeworld2::Graphics::Singlemesh ReferenceFile::singlemesh(ReferenceFile::Context & root, x::file::input::stream & in)
        {
            ...
            for(x::uint32 i = 0; i < total; i++)
            {
                ...
                singlemesh.push(x::move(primitive));
            }
        ...
        void ReferenceFile::vertices(Homeworld2::Graphics::Primitive & primitive, ReferenceFile::Context & root, x::uint32 mask, x::file::input::stream & in)
        {
            x::uint32 total = root.uinteger32(in);
            for(x::uint32 i = 0; i < total; i++)
            {
        ...
        Homeworld2::Graphics::Goblinmesh ReferenceFile::goblinmesh(ReferenceFile::Context & root, x::file::input::stream & in)
        {
            ReferenceFile::debug(root);
        ...
        Homeworld2::Graphics::Engineshape ReferenceFile::engineshape(ReferenceFile::Context & root, x::file::input::stream & in)
        {
            ReferenceFile::debug(root);
        ...
        Homeworld2::Graphics::Engineburn ReferenceFile::engineburn(ReferenceFile::Context & root, x::file::input::stream & in)
        {
            ReferenceFile::debug(root);
            Homeworld2::Graphics::Engineburn engineburn;
            x::string name = root.str(in);
        ...
        void ReferenceFile::navlight(ReferenceFile::Context & root, Homeworld2::Graphics::Reference & object, x::file::input::stream & in)
        {
            ReferenceFile::debug(root);
            x::uint32 total = root.uinteger32(in);
            for(x::uint32 i = 0; i < total; i++)
            {
                Homeworld2::Graphics::Navlight navlight;
                x::string name = root.str(in);
        ...
        Homeworld2::Graphics::Marker ReferenceFile::marker(ReferenceFile::Context & root, x::file::input::stream & in)
        {
            ReferenceFile::debug(root);
            Homeworld2::Graphics::Marker marker;
            while(!root.finish())
            {
                ReferenceFile::Context context = ReferenceFile::context(in, &root);
                switch(context.id())
        ...
        Homeworld2::Graphics::Marker::Head ReferenceFile::markerhead(ReferenceFile::Context & root, x::file::input::stream & in)
        {
            ReferenceFile::debug(root);
            Homeworld2::Graphics::Marker::Head head;
            x::string name = root.str(in);
            x::string parent = root.str(in);
        ...
        Homeworld2::Graphics::Keyframe ReferenceFile::keyframe(ReferenceFile::Context & root, x::file::input::stream & in)
        {
            ReferenceFile::debug(root);
            Homeworld2::Graphics::Keyframe keyframe;
            while(!root.finish())
            {
                ReferenceFile::Context context = ReferenceFile::context(in, &root);
        ...
        Homeworld2::Graphics::Boundary ReferenceFile::boundary(ReferenceFile::Context & root, x::file::input::stream & in)
        {
            ReferenceFile::debug(root);
            Homeworld2::Graphics::Boundary boundary;
            x::string name = root.str(in);
            x::string parent = root.str(in);
            x::uint32 total = root.uinteger32(in);
            for(x::uint32 i = 0; i < total; i++)
        ...
        Homeworld2::Graphics::Collision ReferenceFile::collision(Context & root, x::file::input::stream & in)
        {
            ReferenceFile::debug(root);
            Homeworld2::Graphics::Collision collision;
            x::string name = root.str(in);
            while(!root.finish())
            {
        ...
        Homeworld2::Graphics::Box ReferenceFile::box(ReferenceFile::Context & root, x::file::input::stream & in)
        {
            ReferenceFile::debug(root);
            Homeworld2::Graphics::Box box;
            // min
            x::float32 x = root.real32(in);
            x::float32 y = root.real32(in);
            x::float32 z = root.real32(in);
        ...
        Homeworld2::Graphics::Sphere ReferenceFile::sphere(ReferenceFile::Context & root, x::file::input::stream & in)
        {
            ReferenceFile::debug(root);
            Homeworld2::Graphics::Sphere sphere;
            // center
            x::float32 x = root.real32(in);
            x::float32 y = root.real32(in);
            x::float32 z = root.real32(in);
        ...
        Homeworld2::Graphics::Triangle ReferenceFile::triangle(ReferenceFile::Context & root, x::file::input::stream & in)
        {
            ReferenceFile::debug(root);
            Homeworld2::Graphics::Triangle triangle;
            x::uint32 total = root.uinteger32(in);
            // vertex
            for(x::uint32 i = 0; i < total; i++)
            {
        ...
        Homeworld2::Graphics::Basicmesh ReferenceFile::basicmesh(ReferenceFile::Context & root, x::file::input::stream & in)
        {
            ReferenceFile::debug(root);
            Basicmesh basicmesh;
            while(!root.finish())
        ...
        Homeworld2::Graphics::Description ReferenceFile::description(ReferenceFile::Context & root, x::file::input::stream & in)
        {
            ReferenceFile::debug(root);
            Homeworld2::Graphics::Description description;
            x::string name = root.str(in);
            x::string parent = root.str(in);
        ...
        void ReferenceFile::normals(ReferenceFile::Context & root, Homeworld2::Graphics::Basicmesh & basicmesh, x::file::input::stream & in)
        {
            ReferenceFile::debug(root);
            x::uint32 total = root.uinteger32(in);
            for(x::uint32 i = 0; i < total; i++)
        ...
        Homeworld2::Graphics::Subdivision ReferenceFile::subdivision(ReferenceFile::Context & root, x::file::input::stream & in)
        {
            ReferenceFile::debug(root);
            Homeworld2::Graphics::Subdivision subdivision;
        ...
        void ReferenceFile::information(ReferenceFile::Context & root, Homeworld2::Graphics::Reference & object, x::file::input::stream & in)
        {
            ReferenceFile::debug(root);
            Homeworld2::Graphics::Information information;
            while(!root.finish())
            {
                Context context = ReferenceFile::context(in, &root);
                switch(context.id())
        ...
        void ReferenceFile::information(ReferenceFile::Context & root, Homeworld2::Graphics::Engineglow & engineglow, x::file::input::stream & in)
        {
            ReferenceFile::debug(root);
        ...
        Homeworld2::Graphics::Engineglow ReferenceFile::glow(Context & root, x::file::input::stream & in)
        {
            ReferenceFile::debug(root);
            ...
            while(!in.finish() && !root.finish())
            {
                ...
                switch(context.id())
                {
                    case Reference::INFORMATION:    ReferenceFile::information(context, engineglow, in);    break;
                    case Reference::SINGLEMESH:     engineglow.add(ReferenceFile::singlemesh(context, in)); break;
                    default:                            ReferenceFile::debug(context);                          exceptional();
                }
                root.move(context.size());
                assertion(context.finish() == 0);
