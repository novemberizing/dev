...
namespace x
{
        ...
        public:     stream & operator<<(signed char v)
                    {
                        // TODO: IMPLEMENT THIS
                        char buffer[128];
                        int n = __core_snprintf(buffer, 128, "%d", v);
                        if(n > 0)
                        {
        ...
        public:     stream & operator<<(unsigned char v)
                    {
                        // TODO: IMPLEMENT THIS
                        char buffer[128];
                        int n = __core_snprintf(buffer, 128, "%u", v);
                        if(n > 0)
                        {
                            this->push((x::byte *) buffer, n);
                        }
        ...
        public:     stream & operator<<(long v)
                    {
                        // TODO: IMPLEMENT THIS
                        char buffer[128];
                        int n = __core_snprintf(buffer, 128, "%ld", v);
                        if(n > 0)
                        {
                            this->push((x::byte *) buffer, n);
                        }
        ...
        public:     stream & operator<<(unsigned long v)
                    {
                        // TODO: IMPLEMENT THIS
                        char buffer[128];
                        int n = __core_snprintf(buffer, 128, "%lu", v);
                        if(n > 0)
                        {
                            this->push((x::byte *) buffer, n);
                        }
        ...
        public:     stream & operator<<(long long v)
                    {
                        // TODO: IMPLEMENT THIS
                        char buffer[128];
                        int n = __core_snprintf(buffer, 128, "%lld", v);
                        if(n > 0)
                        {
                            this->push((x::byte *) buffer, n);
                        }
        ...
        public:     stream & operator<<(unsigned long long v)
                    {
                        // TODO: IMPLEMENT THIS
                        char buffer[128];
                        int n = __core_snprintf(buffer, 128, "%llu", v);
                        if(n > 0)
                        {
                            this->push((x::byte *) buffer, n);
                        }
        ...
        public:     stream & operator<<(float v)
                    {
                        // TODO: IMPLEMENT THIS
                        char buffer[128];
                        int n = __core_snprintf(buffer, 128, "%f", v);
                        if(n > 0)
                        {
                            this->push((x::byte *) buffer, n);
                        }
        ...
        public:     stream & operator<<(long double v)
                    {
                        // TODO: IMPLEMENT THIS
                        char buffer[128];
                        int n = __core_snprintf(buffer, 128, "%Lf", v);
                        if(n > 0)
                        {
                            this->push((x::byte *) buffer, n);
                        }
        ...
        public:     stream & operator<<(const char * v)
                    {
                        if(v != nullptr)
                        {
                            this->push((x::byte *) v, __core_strlen(v));
                        }
                        return *this;
                    }
    ...
    inline x::output::stream & flush(x::output::stream & o)
    {
        o.flush();
        return o;
    }
