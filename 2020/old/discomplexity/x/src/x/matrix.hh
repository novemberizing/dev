...
namespace x
{
    ...
    protected:  x::reference<array<T> > __reference;
    ...
    public:     inline const T * data() const
                {
                    ...
                    {
                        const array<T> & o = __reference.get();
                        return o.data();
                    }
                    else
                    {
    ...
    public:     x::matrix<T> & operator=(const x::matrix<T> & o)
                {
                    if(&o != this)
                    {
                        ...
                        __reference = container.sub(o.__row, o.__column);
                        __row = o.__row;
                        __column = o.__column;
                    }
                    return *this;
    ...
    public:     friend x::output::stream & operator<<(x::output::stream & os, const x::matrix<T> & o)
                {
                    os << "[";
                    ...
                    for(x::uint64 i = 0; i < o.__row; i++)
                    {
                        ...
                        {
                            os << container[i * o.__column + j] << (j + 1 == o.__column ? "" : ",");
                        }
                        os << "]" << (i + 1 == o.__row ? "" : ",");
                    }
                    os << "]";
