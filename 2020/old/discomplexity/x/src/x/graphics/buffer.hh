...
namespace x
{
    namespace graphics
    {
        ...
        public:     virtual void push(const x::graphics::vector & o);
        public:     virtual void push(const x::graphics::color & o);
        public:     virtual void push(const x::graphics::coordinate & o);
        public:     virtual void push(x::float32 v);
