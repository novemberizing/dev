...
namespace x
{
    namespace graphics
    {
        ...
        public:     x::graphics::shader & operator=(const x::graphics::shader & o);
        public:     x::graphics::shader & operator=(x::graphics::shader && o) noexcept;
        ...
        public:     shader();
        public:     shader(const x::graphics::shader & o);
        public:     shader(x::graphics::shader && o) noexcept;
